        ...
        <i class="fas fa-search" style="color:white;"></i>
           ...
           <?php
              if(isset($_POST['submit']))
              {
                 ...
                 $a="SELECT `returns` FROM `issue_book` WHERE `username` like '$_POST[search]' AND `approve`='$expired'";
                ...
                INNER JOIN books ON issue_book.bid=books.bid WHERE issue_book.approve='$expired' AND issue_book.username like '$_POST[search]'  
                ";
