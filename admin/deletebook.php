...
<html>
 ...
 <link
  ...
  <body>
    ...
    <br>
    <div class="books__delete">
      <form class="delete" action="" method="post" name="form1">
        <input style="height:40px;width:200px"  type="text" name="bid" type="search" placeholder="Book ID" required></input>
        <button style="height:40px; width:70px;background-color:#6db6b9e6;" class="btn btn-default" name="submit1" type="submit1">
           Delete
        </button>
    </form>
    </div>
<br>
  ...
  if(isset($_POST['submit1']))
  {
      ...
      if(isset($_SESSION['login_username']))
      {
          $a="DELETE FROM `books` WHERE `bid`='$id'";
          $s=mysqli_query($conn,$a);

          ?>
            <script type="text/javascript">
                 alert("Deleted books successfully");
            </script>
          <?php
      }
      else{
